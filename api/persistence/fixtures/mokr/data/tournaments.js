...
// upon post to /api/tournament. it don't seem to be a major issue, just makes
// simultaneous tournament creation using the same 2 users (like these fixtures) fail.
